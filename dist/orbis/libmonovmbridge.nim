proc coil_signalsemaphore*() {.cdecl, importc: "coil_signal_semaphore",
                               header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc coil_waitsemaphore*() {.cdecl, importc: "coil_wait_semaphore",
                             header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
...
proc g_findprograminpath*() {.cdecl, importc: "g_find_program_in_path",
                              header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_free*() {.cdecl, importc: "g_free", header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
...
proc g_getusername*() {.cdecl, importc: "g_get_user_name",
                        header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_getenv*() {.cdecl, importc: "g_getenv", header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
...
proc g_localetoutf8*() {.cdecl, importc: "g_locale_to_utf8",
                         header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_log*() {.cdecl, importc: "g_log", header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
...
proc g_logsetfatalmask*() {.cdecl, importc: "g_log_set_fatal_mask",
                            header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_logv*() {.cdecl, importc: "g_logv", header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_malloc*() {.cdecl, importc: "g_malloc", header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
...
proc g_markupparsecontextparse*() {.cdecl,
                                    ...
                                    header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_memdup*() {.cdecl, importc: "g_memdup", header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
...
proc g_pathisabsolute*() {.cdecl, importc: "g_path_is_absolute",
                           header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_print*() {.cdecl, importc: "g_print", header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
...
proc g_ptrarrayremovefast*() {.cdecl, importc: "g_ptr_array_remove_fast",
                               header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_ptrarrayremoveindex*() {.cdecl, importc: "g_ptr_array_remove_index",
                                header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
...
proc g_setprgname*() {.cdecl, importc: "g_set_prgname",
                       header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_setenv*() {.cdecl, importc: "g_setenv", header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
...
proc g_slistinsertsorted*() {.cdecl, importc: "g_slist_insert_sorted",
                              header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_slistlast*() {.cdecl, importc: "g_slist_last",
                      header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
...
proc g_strchomp*() {.cdecl, importc: "g_strchomp",
                     header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_strchug*() {.cdecl, importc: "g_strchug",
                    header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_strconcat*() {.cdecl, importc: "g_strconcat",
                      header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_strdelimit*() {.cdecl, importc: "g_strdelimit",
                       header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_strdup*() {.cdecl, importc: "g_strdup", header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
...
proc g_stringprintf*() {.cdecl, importc: "g_string_printf",
                         header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_stringtruncate*() {.cdecl, importc: "g_string_truncate",
                           header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_strjoin*() {.cdecl, importc: "g_strjoin",
                    header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_strjoinv*() {.cdecl, importc: "g_strjoinv",
                     header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_strlcpy*() {.cdecl, importc: "g_strlcpy",
                    header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_strndup*() {.cdecl, importc: "g_strndup",
                    header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_strreverse*() {.cdecl, importc: "g_strreverse",
                       header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
...
proc g_unsetenv*() {.cdecl, importc: "g_unsetenv",
                     header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_usleep*() {.cdecl, importc: "g_usleep", header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
