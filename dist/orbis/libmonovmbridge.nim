proc coil_signal_semaphore*() {.cdecl, importc: "coil_signal_semaphore",
  ...
  ##  Empty Comment
proc coil_wait_semaphore*() {.cdecl, importc: "coil_wait_semaphore",
                              header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
...
proc g_ptr_array_remove_fast*() {.cdecl, importc: "g_ptr_array_remove_fast",
                                  header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_ptr_array_remove_index*() {.cdecl, importc: "g_ptr_array_remove_index",
                                   header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
...
proc g_slist_insert_sorted*() {.cdecl, importc: "g_slist_insert_sorted",
                                header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_slist_last*() {.cdecl, importc: "g_slist_last",
                       header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
...
proc g_string_printf*() {.cdecl, importc: "g_string_printf",
                          header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
proc g_string_truncate*() {.cdecl, importc: "g_string_truncate",
                            header: "orbis/libmonovmbridge.h".}
  ##  Empty Comment
