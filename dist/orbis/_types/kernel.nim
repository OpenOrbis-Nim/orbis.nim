const
  MAP_TYPE* = 0x0f
  ORBIS_KERNELEVFILTTIMER* = EVFILT_TIMER
  ORBIS_KERNELEVFILTREAD* = EVFILT_READ
  ORBIS_KERNELEVFILTWRITE* = EVFILT_WRITE
  ORBIS_KERNELEVFILTUSER* = EVFILT_USER
  ORBIS_KERNELEVFILTFILE* = EVFILT_VNODE
  ORBIS_KERNELEVFILTGNM* = EVFILT_GRAPHICSCORE
  ORBIS_KERNELEVFILTVIDEOOUT* = EVFILT_DISPLAY
  ORBIS_KERNELEVFILTHRTIMER* = EVFILT_HRTIMER
  ORBIS_KERNELEVNOTEDELETE* = NOTE_DELETE
  ORBIS_KERNELEVNOTEWRITE* = NOTE_WRITE
  ORBIS_KERNELEVNOTEEXTEND* = NOTE_EXTEND
  ORBIS_KERNELEVNOTEATTRIB* = NOTE_ATTRIB
  ORBIS_KERNELEVNOTERENAME* = NOTE_RENAME
  ORBIS_KERNELEVNOTEREVOKE* = NOTE_REVOKE
  ORBIS_KERNELEVFLAGEOF* = EV_EOF
  ORBIS_KERNELEVFLAGERROR* = EV_ERROR
  ORBIS_KERNELEVFATTRTHFIFO* = 0x01
  ORBIS_KERNELEVFATTRTHPRIO* = 0x02
  ORBIS_KERNELEVFATTRSINGLE* = 0x10
  ORBIS_KERNELEVFATTRMULTI* = 0x20
  ORBIS_KERNELEVFWAITMODEAND* = 0x01
  ORBIS_KERNELEVFWAITMODEOR* = 0x02
  ORBIS_KERNELEVFWAITMODECLEARALL* = 0x10
  ORBIS_KERNELEVFWAITMODECLEARPAT* = 0x20
  ORBIS_KERNELSEMAATTRTHFIFO* = 0x01
  ORBIS_KERNELSEMAATTRTHPRIO* = 0x02
  ORBIS_KERNELMAINDMEMSIZE* = 0x180000000'u
  ORBIS_KERNELWBONION* = 0x0
  ORBIS_KERNELWCGARLIC* = 0x3
  ORBIS_KERNELWBGARLIC* = 0xA
  ORBIS_KERNELPROTCPUREAD* = 0x01
  ORBIS_KERNELPROTCPUWRITE* = 0x02
  ORBIS_KERNELPROTCPURW* = (ORBIS_KERNELPROTCPUREAD or ORBIS_KERNELPROTCPUWRITE)
  ORBIS_KERNELPROTCPUEXEC* = 0x04
  ORBIS_KERNELPROTCPUALL* = (ORBIS_KERNELPROTCPURW or ORBIS_KERNELPROTCPUEXEC)
  ORBIS_KERNELPROTGPUREAD* = 0x10
  ORBIS_KERNELPROTGPUWRITE* = 0x20
  ORBIS_KERNELPROTGPURW* = (ORBIS_KERNELPROTGPUREAD or ORBIS_KERNELPROTGPUWRITE)
  ORBIS_KERNELPROTGPUALL* = ORBIS_KERNELPROTGPURW
