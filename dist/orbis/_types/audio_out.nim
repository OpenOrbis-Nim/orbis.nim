const
  ORBIS_AUDIOOUTPORTTYPEMAIN* = 0
  ORBIS_AUDIOOUTPARAMFORMATS16MONO* = 0
  ORBIS_AUDIOOUTPARAMFORMATS16STEREO* = 1
  ORBIS_AUDIOOUTPARAMFORMATFLOATMONO* = 3
  ORBIS_AUDIOOUTPARAMFORMATFLOATSTEREO* = 4
