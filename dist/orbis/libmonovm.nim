type
  ...
  gdouble* = cdouble
  gunichar2* = uint16
  mono_arraysizet* = guint32
  mono_arraylowerboundt* = gint32
...
type
  ...
  INNER_C_UNION_libmonovm_1* {.importc: "no_name", header: "orbis/libmonovm.h",
    ...
    generic_paramtoken* {.importc: "generic_param_token".}: cint ##  for generic param types, both var and mvar
  ...
  MonoClass* {.importc: "MonoClass", header: "orbis/libmonovm.h", bycopy.} = object
    ...
    has_unitynativeintptr* {.importc: "has_unity_native_intptr", bitsize: 1.}: guint ##  This class has a IntPtr that points to a native class with an asset reference
    ##  next byte
    ...
    gc_descrinited* {.importc: "gc_descr_inited", bitsize: 1.}: guint ##  gc_descr is initialized
    ...
    ##  next byte
    has_staticrefs* {.importc: "has_static_refs", bitsize: 1.}: guint ##  it has static fields that are GC-tracked
    no_specialstaticfields* {.importc: "no_special_static_fields", bitsize: 1.}: guint ##  has no thread/context static fields
    is_comobject* {.importc: "is_com_object", bitsize: 1.}: guint ##  directly or indirectly derives from ComImport attributed class.
                                                                  ...
                                                                  ##
    nested_classesinited* {.importc: "nested_classes_inited", bitsize: 1.}: guint ##  Whenever nested_class is initialized
    ...
    max_interfaceid* {.importc: "max_interface_id".}: guint16
    interface_offsetscount* {.importc: "interface_offsets_count".}: guint16
    interfaces_packed* {.importc: "interfaces_packed".}: ptr ptr MonoClass
    interface_offsetspacked* {.importc: "interface_offsets_packed".}: ptr guint16
    ...
    next_classcache* {.importc: "next_class_cache".}: ptr MonoClass ##  next element in the class_cache hash list (in MonoImage)
  ...
  MonoVTable* {.importc: "MonoVTable", header: "orbis/libmonovm.h", bycopy.} = object
    ...
    imt_collisionsbitmap* {.importc: "imt_collisions_bitmap".}: guint32
    runtime_genericcontext* {.importc: "runtime_generic_context".}: ptr MonoRuntimeGenericContext
  ...
  MonoArrayBounds* {.importc: "MonoArrayBounds", header: "orbis/libmonovm.h",
                     bycopy.} = object
    length* {.importc: "length".}: mono_arraysizet
    lower_bound* {.importc: "lower_bound".}: mono_arraylowerboundt
  ...
  MonoArray* {.importc: "MonoArray", header: "orbis/libmonovm.h", bycopy.} = object
    ...
    max_length* {.importc: "max_length".}: mono_arraysizet ##  total number of elements of the array
  ...
  MonoMethod* {.importc: "MonoMethod", header: "orbis/libmonovm.h", bycopy.} = object
    ...
    is_mbopen* {.importc: "is_mb_open", bitsize: 1.}: cuint ##  This is the fully open instantiation of a generic method_builder. Worse than is_tb_open, but it's temporary
...
proc mono_getrootdomain*(): ptr MonoDomain {.cdecl,
    importc: "mono_get_root_domain", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc wapi_filesharelayout*() {.cdecl, importc: "_wapi_fileshare_layout",
                               header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mini_getdebugoptions*() {.cdecl, importc: "mini_get_debug_options",
                               header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_addinternalcall*() {.cdecl, importc: "mono_add_internal_call",
                               header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_aotregistermodule*() {.cdecl, importc: "mono_aot_register_module",
                                 header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_arraynew*(domain: ptr MonoDomain; eclass: ptr MonoClass; n: uintptr_t): ptr MonoArray {.
    cdecl, importc: "mono_array_new", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_arrayaddrwithsize*(array: ptr MonoArray; size: cint; idx: uintptr_t): cstring {.
    cdecl, importc: "mono_array_addr_with_size", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_arrayelementsize*() {.cdecl, importc: "mono_array_element_size",
                                header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_arraylength*(array: ptr MonoArray): uintptr_t {.cdecl,
    importc: "mono_array_length", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_assemblygetimage*(assembly: ptr MonoAssembly): ptr MonoImage {.cdecl,
    importc: "mono_assembly_get_image", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_assemblyopenfull*() {.cdecl, importc: "mono_assembly_open_full",
                                header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_classfromname*(image: ptr MonoImage; name_space: cstring;
                         name: cstring): ptr MonoClass {.cdecl,
    importc: "mono_class_from_name", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_classgetelementclass*() {.cdecl,
                                    importc: "mono_class_get_element_class",
                                    header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_classgetfields*() {.cdecl, importc: "mono_class_get_fields",
                              header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_classgetmethodfromname*(klass: ptr MonoClass; name: cstring;
                                  param_count: cint): ptr MonoMethod {.cdecl,
    importc: "mono_class_get_method_from_name", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_classgetmethods*(klass: ptr MonoClass; iter: ptr pointer): ptr MonoMethod {.
    cdecl, importc: "mono_class_get_methods", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_classgetfieldfromname*(klass: ptr MonoClass; name: cstring): ptr MonoClassField {.
    cdecl, importc: "mono_class_get_field_from_name",
    header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_classgetpropertyfromname*(klass: ptr MonoClass; name: cstring): ptr MonoProperty {.
    cdecl, importc: "mono_class_get_property_from_name",
    header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_methodgetname*(`method`: ptr MonoMethod): cstring {.cdecl,
    importc: "mono_method_get_name", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_aotgetmethod*(domain: ptr MonoDomain; `method`: ptr MonoMethod): gpointer {.
    cdecl, importc: "mono_aot_get_method", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_propertygetgetmethod*(prop: ptr MonoProperty): ptr MonoMethod {.cdecl,
    importc: "mono_property_get_get_method", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_propertygetsetmethod*(prop: ptr MonoProperty): ptr MonoMethod {.cdecl,
    importc: "mono_property_get_set_method", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_fieldsetvalue*(obj: ptr MonoObject; field: ptr MonoClassField;
                         value: pointer) {.cdecl,
    importc: "mono_field_set_value", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_fieldgetvalue*(obj: ptr MonoObject; field: ptr MonoClassField;
                         value: pointer) {.cdecl,
    importc: "mono_field_get_value", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_getbyteclass*(): ptr MonoClass {.cdecl,
    importc: "mono_get_byte_class", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_classgetnestingtype*() {.cdecl,
                                   importc: "mono_class_get_nesting_type",
                                   header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_classgettype*() {.cdecl, importc: "mono_class_get_type",
                            header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_configparse*() {.cdecl, importc: "mono_config_parse",
                           header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_debuginit*() {.cdecl, importc: "mono_debug_init",
                         header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_debuggeragentparseoptions*() {.cdecl,
    importc: "mono_debugger_agent_parse_options", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_delegatefreeftnptr*() {.cdecl, importc: "mono_delegate_free_ftnptr",
                                  header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_delegatetoftnptr*() {.cdecl, importc: "mono_delegate_to_ftnptr",
                                header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_dlfallbackregister*() {.cdecl, importc: "mono_dl_fallback_register",
                                  header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_domainassemblyopen*(domain: ptr MonoDomain; name: cstring): ptr MonoAssembly {.
    cdecl, importc: "mono_domain_assembly_open", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_domainget*() {.cdecl, importc: "mono_domain_get",
                         header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_environmentexitcodeget*() {.cdecl,
                                      importc: "mono_environment_exitcode_get",
                                      header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_errorcleanup*() {.cdecl, importc: "mono_error_cleanup",
                            header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_errorinit*() {.cdecl, importc: "mono_error_init",
                         header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_errorok*() {.cdecl, importc: "mono_error_ok",
                       header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_fieldgetflags*() {.cdecl, importc: "mono_field_get_flags",
                             header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_fieldgettype*() {.cdecl, importc: "mono_field_get_type",
                            header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_free*() {.cdecl, importc: "mono_free", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_gccollect*() {.cdecl, importc: "mono_gc_collect",
                         header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_gccollectioncount*() {.cdecl, importc: "mono_gc_collection_count",
                                 header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_gcderegisterroot*() {.cdecl, importc: "mono_gc_deregister_root",
                                header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_gcmakerootdescruser*() {.cdecl,
                                   importc: "mono_gc_make_root_descr_user",
                                   header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_gcmaxgeneration*() {.cdecl, importc: "mono_gc_max_generation",
                               header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_gcoutofmemory*() {.cdecl, importc: "mono_gc_out_of_memory",
                             header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_gcregisterrootwbarrier*() {.cdecl, importc: "mono_gc_register_root_wbarrier",
                                      header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_gcwalkheap*() {.cdecl, importc: "mono_gc_walk_heap",
                          header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_gcwbarriergenericstore*() {.cdecl, importc: "mono_gc_wbarrier_generic_store",
                                      header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_getexceptionoutofmemory*() {.cdecl, importc: "mono_get_exception_out_of_memory",
                                       header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_getmethod*() {.cdecl, importc: "mono_get_method",
                         header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_gettrampolinefunc*() {.cdecl, importc: "mono_get_trampoline_func",
                                 header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_imagegetentrypoint*() {.cdecl, importc: "mono_image_get_entry_point",
                                  header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_jitcleanup*() {.cdecl, importc: "mono_jit_cleanup",
                          header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_jitexec*() {.cdecl, importc: "mono_jit_exec",
                       header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_jitinfogetcodesize*() {.cdecl, importc: "mono_jit_info_get_code_size",
                                  header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_jitinfogetcodestart*() {.cdecl,
                                   importc: "mono_jit_info_get_code_start",
                                   header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_jitinit*() {.cdecl, importc: "mono_jit_init",
                       header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_jitinitversion*() {.cdecl, importc: "mono_jit_init_version",
                              header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_jitparseoptions*() {.cdecl, importc: "mono_jit_parse_options",
                               header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_jitsetaotonly*() {.cdecl, importc: "mono_jit_set_aot_only",
                             header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_loaderlock*() {.cdecl, importc: "mono_loader_lock",
                          header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_loaderunlock*() {.cdecl, importc: "mono_loader_unlock",
                            header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_locksdump*() {.cdecl, importc: "mono_locks_dump",
                         header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_main*() {.cdecl, importc: "mono_main", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_objectgetclass*() {.cdecl, importc: "mono_object_get_class",
                              header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_objectgetsize*() {.cdecl, importc: "mono_object_get_size",
                             header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_privilegesfinishinit*() {.cdecl,
                                    importc: "mono_privileges_finish_init",
                                    header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerinstall*() {.cdecl, importc: "mono_profiler_install",
                               header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerinstallallocation*() {.cdecl,
    importc: "mono_profiler_install_allocation", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerinstallclass*() {.cdecl,
                                    importc: "mono_profiler_install_class",
                                    header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerinstallenterleave*() {.cdecl,
    importc: "mono_profiler_install_enter_leave", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerinstallexception*() {.cdecl, importc: "mono_profiler_install_exception",
                                        header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerinstallgc*() {.cdecl, importc: "mono_profiler_install_gc",
                                 header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerinstallgcmoves*() {.cdecl, importc: "mono_profiler_install_gc_moves",
                                      header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerinstallgcroots*() {.cdecl, importc: "mono_profiler_install_gc_roots",
                                      header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerinstalljitcompile*() {.cdecl,
    importc: "mono_profiler_install_jit_compile", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerinstalljitend*() {.cdecl,
                                     importc: "mono_profiler_install_jit_end",
                                     header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerinstallmodule*() {.cdecl,
                                     importc: "mono_profiler_install_module",
                                     header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerinstallmonitor*() {.cdecl,
                                      importc: "mono_profiler_install_monitor",
                                      header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerinstallruntimeinitialized*() {.cdecl,
    importc: "mono_profiler_install_runtime_initialized",
    header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerinstallstatistical*() {.cdecl,
    importc: "mono_profiler_install_statistical", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerinstallthread*() {.cdecl,
                                     importc: "mono_profiler_install_thread",
                                     header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerinstallthreadname*() {.cdecl,
    importc: "mono_profiler_install_thread_name", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilerload*() {.cdecl, importc: "mono_profiler_load",
                            header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_profilersetevents*() {.cdecl, importc: "mono_profiler_set_events",
                                 header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_raiseexception*() {.cdecl, importc: "mono_raise_exception",
                              header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_registerbundledassemblies*() {.cdecl,
    importc: "mono_register_bundled_assemblies", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_runtimeinvoke*(`method`: ptr MonoMethod; obj: pointer;
                         params: ptr pointer; exc: ptr ptr MonoObject): ptr MonoObject {.
    cdecl, importc: "mono_runtime_invoke", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_runtimequit*() {.cdecl, importc: "mono_runtime_quit",
                           header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_runtimeresourcelimit*() {.cdecl,
                                    importc: "mono_runtime_resource_limit",
                                    header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_runtimeresourcesetcallback*() {.cdecl,
    importc: "mono_runtime_resource_set_callback", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_runtimerunmain*() {.cdecl, importc: "mono_runtime_run_main",
                              header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_runtimesetshuttingdown*() {.cdecl, importc: "mono_runtime_set_shutting_down",
                                      header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_securityenablecoreclr*() {.cdecl,
                                     importc: "mono_security_enable_core_clr",
                                     header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_securitysetcoreclrplatformcallback*() {.cdecl,
    importc: "mono_security_set_core_clr_platform_callback",
    header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_setassembliespath*() {.cdecl, importc: "mono_set_assemblies_path",
                                 header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_setdirs*() {.cdecl, importc: "mono_set_dirs",
                       header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_stackwalknoil*() {.cdecl, importc: "mono_stack_walk_no_il",
                             header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_stringchars*() {.cdecl, importc: "mono_string_chars",
                           header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_stringfromutf16*() {.cdecl, importc: "mono_string_from_utf16",
                               header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_stringlength*() {.cdecl, importc: "mono_string_length",
                            header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_stringnew*(domain: ptr MonoDomain; text: cstring): ptr MonoString {.
    cdecl, importc: "mono_string_new", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_stringnewwrapper*() {.cdecl, importc: "mono_string_new_wrapper",
                                header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_stringtoutf8*(string_obj: ptr MonoString): cstring {.cdecl,
    importc: "mono_string_to_utf8", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_stringtoutf8checked*() {.cdecl,
                                   importc: "mono_string_to_utf8_checked",
                                   header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_objectunbox*(obj: ptr MonoObject): pointer {.cdecl,
    importc: "mono_object_unbox", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_objectnew*(domain: ptr MonoDomain; Klass: ptr MonoClass): ptr MonoObject {.
    cdecl, importc: "mono_object_new", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_runtimeobjectinit*(this_obj: ptr MonoObject) {.cdecl,
    importc: "mono_runtime_object_init", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_threadattach*(domain: ptr MonoDomain): ptr MonoThread {.cdecl,
    importc: "mono_thread_attach", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_threadcurrent*(): ptr MonoThread {.cdecl,
    importc: "mono_thread_current", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_threadgetmain*(): ptr MonoThread {.cdecl,
    importc: "mono_thread_get_main", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_threadsetmain*(thread: ptr MonoThread) {.cdecl,
    importc: "mono_thread_set_main", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_threaddetach*() {.cdecl, importc: "mono_thread_detach",
                            header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_threadsuspendallotherthreads*() {.cdecl,
    importc: "mono_thread_suspend_all_other_threads",
    header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_threadssetdefaultstacksize*() {.cdecl,
    importc: "mono_threads_set_default_stacksize", header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_threadssetshuttingdown*() {.cdecl, importc: "mono_threads_set_shutting_down",
                                      header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_typegetclass*() {.cdecl, importc: "mono_type_get_class",
                            header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_typegettype*() {.cdecl, importc: "mono_type_get_type",
                           header: "orbis/libmonovm.h".}
  ##  Empty Comment
proc mono_unhandledexception*() {.cdecl, importc: "mono_unhandled_exception",
                                  header: "orbis/libmonovm.h".}
  ##  Empty Comment