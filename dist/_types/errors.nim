...
const
  ORBIS_KERNEL_ERROR_EPERM* = 0x80020001
...
const
  ORBIS_AUDIO_OUT_ERROR_NOT_OPENED* = 0x80260001
...
const
  ORBIS_VIDEO_OUT_ERROR_INVALID_VALUE* = 0x80290001
...
const
  ORBIS_PAD_ERROR_INVALID_ARG* = 0x80920001
...
const
  ORBIS_USER_SERVICE_ERROR_INTERNAL* = 0x80960001
