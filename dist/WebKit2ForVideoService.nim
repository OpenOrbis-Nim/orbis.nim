...
proc WKBundleFrameCopyLayerTreeAsText*()
  ##  Empty Comment
proc WKBundleFrameCopyMarkerText*()
  ##  Empty Comment
...
proc WKBundleFrameForJavaScriptContext*()
  ##  Empty Comment
proc WKBundleFrameGetComputedStyleIncludingVisitedInfo*()
  ##  Empty Comment
...
proc WKBundleFrameGetJavaScriptWrapperForRangeForWorld*()
  ##  Empty Comment
proc WKBundleFrameGetNumberOfActiveAnimations*()
  ##  Empty Comment
...
proc WKBundleFrameIsMainFrame*()
  ##  Empty Comment
proc WKBundleFramePauseAnimationOnElementWithId*()
  ##  Empty Comment
...
proc WKBundleSwitchNetworkLoaderToNewTestingSession*()
  ##  Empty Comment
proc WKCertificateInfoGetCertificateChain*()
  ##  Empty Comment
...
proc WKContextGetResourceCacheManager*()
  ##  Empty Comment
proc WKContextGetSharedProcessContext*()
  ##  Empty Comment
proc WKContextGetSharedThreadContext*()
  ##  Empty Comment
